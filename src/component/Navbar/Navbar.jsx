...
const Navbar = () => {
  ...
  const menuOptions = [
    ...
    { text: "Ticket Booking", icon: <InfoIcon />, path: "/ticket" },
    { text: "Canteen", icon: <CommentRoundedIcon />, path: "/canteen" },
    { text: "Maps", icon: <LocationOnIcon />, path: "/contact" },
    { text: "Feedback", icon: <ThumbUpAltIcon />, path: "/work" },
    isLoggedIn
        ...
        <div className="navbar-links-container">
          {menuOptions.map((item, index) =>
            item.path ? (
              ...
              <button className="primary-button" key={index} onClick={item.action}>
                {item.text}
              </button>
            )
          )}
